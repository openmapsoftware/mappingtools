...
/**
 * This is the item provider adapter for a {@link com.openMap1.mapper.Annotations} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AnnotationsItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MapperPackage.Literals.ANNOTATIONS__NOTES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Annotations.class)) {
			case MapperPackage.ANNOTATIONS__NOTES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MapperPackage.Literals.ANNOTATIONS__NOTES,
				 MapperFactory.eINSTANCE.createNote()));
	}
