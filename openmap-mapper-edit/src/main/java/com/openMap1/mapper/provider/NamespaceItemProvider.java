...
/**
 * This is the item provider adapter for a {@link com.openMap1.mapper.Namespace} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NamespaceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Namespace_uRL_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Namespace_uRL_feature", "_UI_Namespace_type"),
				 MapperPackage.Literals.NAMESPACE__URL,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MapperPackage.Literals.NAMESPACE__PREFIX,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		if (prefix == null) prefix = "no prefix";
		String label = prefix + ": " + ns.getURL();
